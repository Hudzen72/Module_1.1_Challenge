...
print(f"There are {number_of_loans} numbers of loans")
...
# YOUR CODE HERE!
print(f"The cost of total loans is {total_of_all_loans}")
average_loan_amount = total_of_all_loans / number_of_loans
print(f"Average loan cost is {average_loan_amount}")
...
print(f"The future value of loans is {Future_Value}")
